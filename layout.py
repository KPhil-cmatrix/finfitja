...
FullNote = (
    "Disclaimer: FinFit JA is an academic prototype that uses the system's curated datasets to "
    "offer general banking recommendations and information. It does not claim to offer "
    "professional or legal financial advice. All information presented is accurate only as of "
    "March 2026. Before making any final decisions, users should immediately verify all product "
    "details, terms, and conditions with the selected financial institution(s)."
)
